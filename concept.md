...
Notifications now fire only after the policy mutex has been released, and the USB source detect IRQ relies solely on the shared worker, eliminating lock inversion risks and duplicate change events while preserving user space visibility.
